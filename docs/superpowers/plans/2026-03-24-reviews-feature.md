...
and Tiptap for rich text editing.
...
**Files:**
- Create: `supabase/migrations/001_create_reviews_table.sql`
...
## Task 10: 添加Tailwind Prose样式

**Files:**
- Modify: `tailwind.config.js`

- [ ] **Step 1: 安装Typography插件**
...
git commit -m "feat: add Tailwind Typography plugin

Add @tailwindcss/typography for styling rich text content
in review detail pages. Enables prose-* utility classes.
